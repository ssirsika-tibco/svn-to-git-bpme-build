...
public class SAMLLoginModule extends BPMAbstractLognModule {

	private DEDelegate deDelegate;
	
    private static CLFClassContext logCtx = CloudLoggingFramework.init(SAMLLoginModule.class, AuthLoggingInfo.instance);
